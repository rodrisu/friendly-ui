...
import {
  TripCardCarpoolExample,
  TripCardCarpoolTagExample,
  TripCardPassengersExample,
} from './TripCard.example'

<Meta title={`${BASIC}/Card (TripCard)`} />

# **Card**

<Canvas>
  <Story name="Carpool trip">
    <TripCardCarpoolExample />
  </Story>
</Canvas>

<Canvas>
  <Story name="Carpool trip with passengers">
    <TripCardPassengersExample />
  </Story>
</Canvas>

<Canvas>
  <Story name="Carpool trip with Tag">
    <TripCardCarpoolTagExample />
  </Story>
</Canvas>
