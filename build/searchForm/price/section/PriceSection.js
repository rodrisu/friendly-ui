...
var PriceSection = function (_a) {
    ...
    var _b = (0, react_1.useState)({
        name: props.name,
        value: props.value,
    }), priceValue = _b[0], setPriceValue = _b[1];
    ...
    return (react_1.default.createElement(baseStyles_1.TransitionSection, { ref: ref, role: "dialog", className: className },
        react_1.default.createElement(FullHeightSection, null,
            react_1.default.createElement(SectionContent, null,
                ...
                react_1.default.createElement(price_1.Price, __assign({}, props, { onChange: setPriceValue, display: price_1.PriceDisplay.LARGE }))),
            react_1.default.createElement(SectionFooter, null,
                react_1.default.createElement(button_1.Button, { status: button_1.ButtonStatus.PRIMARY, onClick: function () { return onChange(priceValue); } }, confirmLabel)))));
};
