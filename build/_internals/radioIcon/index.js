...
var RadioIcon = function (_a) {
    ...
    if (isChecked) {
        return react_1.default.createElement(circleIcon_1.CircleIcon, { iconColor: branding_1.color.blue, isDisabled: isDisabled, innerDisc: true });
    }
